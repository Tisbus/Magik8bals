package com.example.magik8bals
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        imageViewBall.setImageResource(R.drawable.magic_8_ball)
        val askButton: Button = findViewById(R.id.askButton)
        askButton.setOnClickListener { shakeBall() }
    }

    private fun shakeBall() {
        val imageViewBall: ImageView = findViewById(R.id.imageViewBall)
        val changeBall : Int = when((1..21).random()){
        ...
        imageViewBall.setImageResource(changeBall)
    }
}